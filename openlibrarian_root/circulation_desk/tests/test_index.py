...
TC_LIBRARIES = [
    {
        "s": "TRS",
        "i": "aea571dbde5eb6ebec93c91b95486539b9491962",
        "t": "To Read (S)",
        "d": "Books on the shelf ready to read",
        "c": "Books & Literature (OpenLibrarian)",
        "b": [
            {
                "t": "The Olive Farm",
                "a": "Carol Drinkwater",
                "i": "0349114749",
                "c": "https://covers.openlibrary.org/b/isbn/0349114749-M.jpg",
                "h": "N",
            },
            {
                "t": "Beauty",
                "a": "Sheri S. Tepper",
                "i": "1857987225",
                "c": "https://covers.openlibrary.org/b/isbn/1857987225-M.jpg",
                "h": "N",
            },
            {
                "t": "Angry Aztecs",
                "a": "Terry Deary",
                "i": "9781407104256",
                "c": "https://covers.openlibrary.org/b/isbn/9781407104256-M.jpg",
                "h": "N",
            },
            {
                "t": "March",
                "a": "Geraldine Brooks",
                "i": "0007165870",
                "c": "https://covers.openlibrary.org/b/isbn/0007165870-M.jpg",
                "h": "N",
            },
        ],
    },
    {
        "s": "TRW",
        "i": "f76a2d0c13b20a32eeefc4e4f5b393f7b0d6dccc",
        "t": "To Read (W)",
        "d": "Books I want to read but do not own yet",
        "c": "Books & Literature (OpenLibrarian)",
        "b": [
            {
                "t": "Tomorrow",
                "a": "Unknown Author",
                "i": "9780718183899",
                "c": "https://covers.openlibrary.org/b/isbn/9780718183899-M.jpg",
                "h": "Y",
            },
            {
                "t": "Flesh House",
                "a": "Stuart MacBride",
                "i": "9780007244546",
                "c": "https://covers.openlibrary.org/b/isbn/9780007244546-M.jpg",
                "h": "Y",
            },
        ],
    },
    {
        "s": "CR",
        "i": "fe7046323fc3ccc7c6b2748ba58295fc4206a1a3",
        "t": "Currently Reading",
        "d": "Books I am currently reading",
        "c": "Books & Literature (OpenLibrarian)",
        "b": [
            {
                "t": "MANDIBLES A FAMILY 2029-47_PB",
                "a": "SHRIVER  LIONEL",
                "i": "9780007560776",
                "c": "https://covers.openlibrary.org/b/isbn/9780007560776-M.jpg",
                "h": "N",
            }
        ],
    },
    {
        "s": "HR",
        "i": "e1d342f8901e9db6dcd671b974e130f8bc5353f7",
        "t": "Have Read",
        "d": "Books I have finished reading",
        "c": "Books & Literature (OpenLibrarian)",
        "b": [
            {
                "t": "Walker's Guide to Outdoor Clues and Signs",
                "a": "Tristan Gooley",
                "i": "9781444780109",
                "c": "https://covers.openlibrary.org/b/isbn/9781444780109-M.jpg",
                "h": "Y",
            },
            {
                "t": "Humankind",
                "a": "Rutger Bregman",
                "i": "9781408898956",
                "c": "https://covers.openlibrary.org/b/isbn/9781408898956-M.jpg",
                "h": "Y",
            },
            {
                "t": "Hackers",
                "a": "Steven Levy",
                "i": "0140232699",
                "c": "https://covers.openlibrary.org/b/isbn/0140232699-M.jpg",
                "h": "Y",
            },
        ],
    },
...
TC_REVIEWS = {
    "9781444780109": {
        "id": "a479b971d0d1e054dae477e8eed7a4897ef62e86de547de73c98ca6b05261783",
        "exid": "isbn",
        "rating": 4.5,
        "content": "Love it!",
        "tags": [],
...
class BaseUnitTests(TestCase):
    ...
    def setUp(self):
        ...
        self.content = [
            ...
            "Sign-up",
            "Log-in",
            "an open social network protocol",
            "heart of this app is built on the brilliant work",
        ]
        self.redirect = False
...
class IndexUnitTests(TestCase):
    ...
    def test_logged_in_npub(self):
        ...
        self.assertNotIn(
            b"heart of this app is built on the brilliant work", response.content
        )
    ...
    def test_urls_of_links(self):
        ...
        response = self.client.get("/")
        self.assertIn(
            b'href="https://github.com/RydalWater/OpenLibrarian/issues"',
            response.content,
        )
